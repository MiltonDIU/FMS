...
>
    ...
    >
        ...
        <div class="fi-ta-main">
            ...
            @if ($hasPagination)
                @php
                    $_hasExtremePaginationLinks = $hasExtremePaginationLinks();
                    $_paginationPageOptions = $getPaginationPageOptions();
                @endphp

                <x-filament::pagination
                    :extreme-links="$_hasExtremePaginationLinks"
                    :page-options="$_paginationPageOptions"
                    :paginator="$records"
                    class="mb-4"
                />
            @endif
