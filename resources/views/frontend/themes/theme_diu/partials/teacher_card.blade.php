    ...
    <div class="absolute left-5 flex items-center gap-3" style="bottom: -24px;">
        <div class="w-20 h-20 rounded-xl overflow-hidden bg-white p-1 shadow-md ring-1 ring-slate-200 shrink-0">
            @if($teacher->photo_url)
                <img src="{{ $teacher->photo_url }}" alt="{{ $teacher->first_name }}" class="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform duration-300" />
            @else
    ...
    <div class="group flex flex-col bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-diu-primary/30 transition-all duration-300 overflow-hidden">
        <div class="flex-1">
            <div class="relative h-20 bg-gradient-to-r from-diu-primary to-diu-primary-hover">
                <div class="absolute inset-0 opacity-20" style="background-image: radial-gradient(circle, rgba(255,255,255,0.6) 1px, transparent 1px); background-size: 16px 16px; "></div>
                <div class="absolute -bottom-6 left-5 w-20 h-20 rounded-xl overflow-hidden bg-white p-1 shadow-md ring-1 ring-slate-200" style="bottom: -24px;">
                    @if($teacher->photo_url)
                        <img src="{{ $teacher->photo_url }}" alt="{{ $teacher->first_name }}" class="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform duration-300" />
                    @else
