    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex items-center gap-3 justify-between md:justify-end">
                ...
                @if(auth()->check())
                    <a href="{{ url('/admin') }}" class="bg-diu-primary hover:bg-diu-primary-hover text-white text-xs font-bold px-4 py-2.5 rounded-xl transition-all duration-200 flex items-center gap-2 shadow-sm border border-diu-primary/25 active:scale-95">
