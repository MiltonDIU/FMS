...
return [
     ...
     */
    // App\Models\Activity extends the package's own and stamps every entry with
    // the IP address and user agent it came from — the package captures neither,
    // and v5 removed the taps hook that used to allow adding defaults.
